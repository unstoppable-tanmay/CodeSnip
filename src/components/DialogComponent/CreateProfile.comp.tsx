...
import {
  ...
  isLinkValid,
} from "@/src/lib/createProfileHelper";
      ...
      <div className="Content max-h-[80vh] overflow-y-scroll flex flex-col gap-5 w-full h-full overflow-x-hidden no-scrollbar">
        ...
        <div className="images flex w-full gap-4">
          ...
          <label
            ...
            className="profileImg h-[16vh] aspect-square rounded-[10px] bg-def_blue_gray_dark relative overflow-hidden"
          >
            {profileImage && (
              <Image fill src={profileImage} alt="" className="" />
            )}
          </label>
          <input
            type="file"
          ...
          <label
            htmlFor="coverImage"
            className="CoverImage flex-1 h-[16vh] rounded-[10px] bg-def_blue_gray_dark relative overflow-hidden"
          >
        ...
        <textarea
          ...
          className="text-xs bg-def_blue_gray_dark rounded-[7px] outline-none resize-none p-2 text-def_white/40 font-FiraMono min-h-[60px]"
        ></textarea>
